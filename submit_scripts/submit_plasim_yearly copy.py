...
def main(argv):
    ...
    base_job_script = '/work2/09979/awikner/stampede3/PLASIM/job_scripts/plasim_yearly_base.sh'
    ...
    for simstep in range(simstep_start + 1, simstep_start + simsteps + 1):
        ...
        job_sub = ['srun', '--exclusive', '-N', '1', '-n', '48', '-c', '48', 'python', get_yearly_ground_truth_data, data_dir, runs_str, str(simstep)]
